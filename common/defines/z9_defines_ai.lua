NDefines.NAI.GENERATE_WARGOAL_THREAT_BASELINE = 0.0 		-- The baseline for what the AI considers the world is getting dangerous and we want to generate wargoals with no antagonize value
